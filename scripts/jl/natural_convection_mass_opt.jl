...
thermals = setup_thermal_graph.NaturalConvectionGraph(circuit_graph, alpha=21.7e-6, dx=0.1, mu=18e-6, D=0.065, h="dynamic", cp=1000., T_amb=298.0, rho=1.0)


pybamm_pack = pack.Pack(model, circuit_graph, functional=functional, thermals=thermals, voltage_functional=voltage_functional)
...
prob = ODEProblem(func, jl_vec, (0.0, 1000/timescale), p)
